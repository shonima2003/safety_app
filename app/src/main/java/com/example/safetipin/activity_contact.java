...
import com.example.safetipin.safetipin.ContactsAdapter;
import com.example.safetipin.safetipin.MainActivity;
import com.example.safetipin.safetipin.MyOnClickListener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dialog dialog = new Dialog(com.example.safetipin.activity_contact.this);
                ...
                save.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(numberText.length() == 10){
                            ...
                            Toast.makeText(com.example.safetipin.activity_contact.this, "Enter valid number!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
